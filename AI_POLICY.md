...
The Modern.UIKit project has strict rules for AI usage:
...
These rules apply only to outside contributions to Modern.UIKit. Maintainers
...
Please remember that Modern.UIKit is maintained by humans.
...
Modern.UIKit is written with plenty of AI assistance, and many maintainers
